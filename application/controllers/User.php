...
class User extends CI_Controller{
  ...
  public function get_users()
  {
    ...
    if (!$this->ion_auth->logged_in())
		...
		// else if ($this->data['user_profile']['user_group']!=0) // remove this elseif if you want to enable this for non-admins
		// {
  ...
  public function edit($id)
    ...
    //$this->form_validation->set_rules('email', 'Emel', 'valid_email|required');
		...
		if (isset($_POST) && !empty($_POST))
		{
			...
			if ($this->form_validation->run() === TRUE)
			{
				...
				{
          $data = array(
  					//'username' => $this->input->post('nic_no'),
      ...
      $active = $this->input->post('active');
		...
		if ($this->form_validation->run() === TRUE)
		{
            ...
            if($this->input->post('user_group')==1){
                ...
                $message .= "<head>Assalamualaikum dan Selamat Sejahtera.<br><br>Di bawah adalah maklumat anda untuk mengakses Sistem Coffee-Fastlane. Layari ".base_url('customer/register')." untuk mengakses sistem ini.</head>";
