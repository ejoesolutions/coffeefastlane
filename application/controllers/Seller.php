...
class Seller extends CI_Controller{
 ...
 public function create_shop(){
   ...
   $shop=array(
    ...
    echo "<script type='text/javascript'>alert('$m');window.location.href = '" . base_url() . "customer/dashboard';</script>";
 }
 ...
 public function upd_verify()
 {
   ...
   $message .= anchor('customer/register');
   ...
   // Muat naik imej
    ...
    if($this->data['user_profile']['user_group']==2){
      ...
      //}
        ...
        //   echo "<script type='text/javascript'>alert('$m');</script>";
        //   redirect('seller/upd_seller/'.$this->input->post('seller_id'), 'refresh');
