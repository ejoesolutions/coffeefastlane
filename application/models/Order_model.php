...
class Order_model extends CI_Model{
  ...
  public function get_order($user_id='',$order_id='')
  {
    ...
    $this->db->join('
      (
        select distinct order_id as o_id,order_status from ci_order_status where order_status=0
        ) as order_status
  ...
  public function get_productID_2($order_id)
  {
    ...
    public function get_order_status($order_id='',$seller_id=''){
      ...
      $this->db->select('os.order_status_id,os.seller_id,os.order_id,os.order_status,ds.shop_name,ds.full_name,ds.email,ds.phone,ds.address,ds.postcode,ds.town_area,ds.state,ct.transaction_record,ct.next_transaction,ct.transaction_status,os.shipping_seller,os.cancelled_desc');
