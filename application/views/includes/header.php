  ...
  <div class="pull-right">
    ...
    <ul class="header-btns">
        ...
        <li class="header-account header-search">
          <!-- <div class="header-search"> -->
            <?php echo form_open('page/search',array('class'=>'')); ?>
              <input class="input search-input" type="text" name="search_text" placeholder="Enter your keyword" style="height:40px">
      ...
      <?php if(!empty($user_profile)){ ?>
        <li><span class="black-color">Hello, <br><?php echo $user_profile['full_name'] ?></span></li>
      <?php } ?>
      <!-- /Cart -->
      ...
      <li class="dropdown dropdown-user header-cart">
        ...
        <ul class="dropdownshop-menu dropdown-menu-default">
          ...
          if(!$this->ion_auth->logged_in()){
            ?>
            <li align="center">
              <a href="<?php echo base_url('customer/register') ?>"><button class="main-btn">Login/Register</button></a>
            </li>
            <?php
          }else{
          ?>
          <li align="center">
            <a href="<?php echo base_url('customer/dashboard') ?>"><button class="main-btn">My Account</button></a>
          </li>
          <?php
          if(empty($shop['seller_id'])){
           ...
           ?>
           <li align="center">
             <a href="<?php echo base_url('customer/logout') ?>"><button class="main-btn">Logout</button></a>
           </li>
          <?php
          }
          ?>
