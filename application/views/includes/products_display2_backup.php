    ...
    if(!empty($products)){
      ...
      <div class="col-md-2 col-sm-6 col-xs-6">
        ...
        <div class="content product product-single">
					...
					<div class="quarter-circle-bottom-left" style="font-size:80%;text-align:center;"><?php echo number_format($row->weight,0).'g'; ?></div>
             <img style="border:1px solid #e7e4e4;padding-left:15px;padding-right:15px;padding-top:15px;padding-bottom:15px;" class="content-image img-fluid d-block mx-auto" src="<?php echo base_url().'images/'.$row->image_file; ?>" alt="">
                    ...
                    <p style="color:white">
                      ...
                      ?>
                      <br><small><?php echo $row->vendor_name ?></small><br>
                      ...
                      <a href="<?php echo base_url('catalog/product_detail') ?>/<?php echo $row->product_id; ?>">View More</a>
										</p>
									</div>
						     </div>
				</div>
        <div class="product-body" align="right">
          <h4 class="product-price">
            ...
            echo "RM ".number_format(round($clean_price,0)).'.00';
             ?>
          </h4>

          <p class="product-name" style="color:black;">
            <a href="<?php echo base_url('catalog/product_detail') ?>/<?php echo $row->product_id; ?>"><?php echo $row->product_name ?></a>
