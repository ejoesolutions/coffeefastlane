  ...
  <li class="dropdown dropdown-user">
    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
      ...
      if ($user_profile['user_group']==1):
          ?><span class="username"> <i class="icon-user"></i> Welcome, <?php echo  $user_profile['full_name'].' [ADMIN]'; ?> </span><?php
      endif;
      if ($user_profile['user_group']==0):
          ?><span class="username"> <i class="icon-user"></i> Welcome, <?php echo  $user_profile['full_name'].' [SUPERADMIN]'; ?> </span><?php
      endif;
      if ($user_profile['user_group']==2):
          ?><span class="username"> <i class="icon-user"></i> Welcome, <?php echo  $user_profile['full_name'].' [SELLER]'; ?> </span><?php
      endif;
