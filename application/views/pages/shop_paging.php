<div class="row">
  ...
  <div class="col-md-12">
      ...
      <div class="content product product-single">
        <div class="product-thumb">
          ...
          if ($seller['shop_image']) {
            ...
            $image_properties = array(
            'src'   => 'https://dummyimage.com/300x300/d6c7d6/9b9dad.jpg&text=No+Image',
            'alt'   => 'No image',
            'class' => 'img-thumbnail',
            'width' => '200',
            'height'=> '200',
    ...
    <div class="col-md-9 h4">
      <strong>Shop Name</strong> : <?php echo $seller['shop_name'] ?>
      <br><br><strong>Phone</strong> : <?php echo $seller['phone'] ?>
      <br><br><strong>Email</strong> : <?php echo $seller['email'] ?>
      <br><br><strong>Address</strong> : <?php echo $seller['address'] ?>,<?php echo $seller['postcode'] ?>,<?php echo $seller['town_area'] ?>,<?php echo $seller['state'] ?>
    </div>
  </div> 
  ...
  <?php
    ...
    if($this->uri->segment(3)!=''){
      $this->db->where('seller_id',$this->uri->segment(3));
    }
