              ...
              <tbody>
                ...
                $arr_Item=[];
	                  ...
	                  <tr>
	                    ...
	                    <td>
	                      <?php
	                      echo 'RM '.number_format($key['total_all'],2).' for ';
	                    ...
	                    <td><?php
        					...
        					foreach ($order_status as $k) {
										if($k['order_id']==$key['order_id'])
										{
											...
											if($k['order_status']==0 && $key['payment_type']!="Online Banking"){
												...
												echo 'Processing'; //to ship
											}
											else if($k['order_status']==2){
												echo 'Packing'; //Processing
											}
	                     ...
	                     ?></td>
	                     <td><?php echo anchor('customer/view_order/'.$key['order_id'], '<button type="button" class="primary-btn">View</button>') ?></td>
	                  </tr>
	                  <?php
	                }
								}
