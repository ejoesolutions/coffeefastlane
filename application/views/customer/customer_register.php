	...
	<div class="col-md-6">
		<div class="">
			<div class="section-title">
				<h3 class="title">Already a customer? LOGIN</h3>
			</div>
			<?php echo form_open('customer/login',array('class'=>'clearfix')) ?>
			...
			<div class="form-group">
				<table width="100%">
					<tr>
						...
						<td><button type="submit" class="primary-btn" name="submit">Login</button></td>
		...
		<!-- /.modal-dialog -->
            ...
            <div class="form-group">
              ...
              <div class="form-actions">
                ...
                <button type="submit" id="register-submit-btn" class="primary-btn">Register</button>
              </div>
						</div>
            <?php echo form_close() ?>
					</div>
