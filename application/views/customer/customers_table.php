  ...
  <div class="portlet-body">
    <table class="table table-bordered" id="sample_3">
      ...
      <tbody>
        ...
        <tr>
          <td><?php echo $i++;?></td>
          <td><?php echo anchor('customer/get_history/'.$customer->mykad, $customer->name);?></td>
          <!-- <th class="text-center"><?php echo anchor('orders/detail/'.$order->order_id, 'View') ?></th> -->
          ...
          <td class="text-center">
            <?php echo anchor('customer/detail/'.$customer->customer_id, 'View') ;?>
          </td>
        <?php endif; ?>
        </tr>
      <?php endforeach;
