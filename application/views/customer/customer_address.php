          ...
          <div class="col-md-8">
            ...
            <table class="" border=0  width="100%">
								<tr>
									...
									<tr>
	                  <td>Name</td><td><b><?php echo $ship['ship_name'] ?><b></td>
	                </tr>
	                <tr>
	                  <td>Phone</td><td><?php echo $ship['ship_phone'] ?></td>
	                </tr>
	               <tr>
	                  <td>Address</td><td><?php echo $ship['ship_address'].'<br>'.$ship['ship_postcode'].' '.$ship['ship_area'].'<br>'.$ship['state'] ?></td></td>
	                </tr>
	                <tr>
	                  <td><a class="" data-toggle="modal" href="#editShipAddress"><button class="primary-btn">Edit</button></a></td>
	                </tr>
            </table>
	            ...
	            <div class="modal-dialog modal-xl">
	              <div class="modal-content">
	                ...
	                <div class="modal-body">
	                  <?php echo form_open('customer/update_shipAddress',array('class'=>'form-horizontal')) ?>
