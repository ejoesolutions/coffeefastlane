<div class="row">
            ...
            <div class="payments-methods">
							...
							<div class="input-checkbox">
								...
								<div class="caption">
									<p>Make your payment directly using payment gateway Billplz. Your order will not be shipped until the funds have cleared in our account.
										<p>
								</div>
							</div>
            ...
            <div class="order-summary clearfix">
              ...
              <table class="shopping-cart-table table">
                ...
                <tfoot>
                   <tr>
                    ...
                    <th>SUB-TOTAL</th>
                    <th colspan="2" class="text-center">RM <?php echo number_format($total_sub,2) ?></th>
                  </tr>
                  <tr>
                    <th class="empty" colspan="2"></th>
                  ...
                  <tr>
                    ...
                    <th colspan="2" class="total text-center"><input type="text" name="total_all1" id="total_all1" value="RM <?php echo number_format($total_all,2) ?>" readonly class="text-center"></th>
                  </tr>
                </tfoot>
              </table>
              ...
              <div class="pull-right">
                ...
                <button class="primary-btn" type="submit" name="btnPlaceOrder">Place Order</button>
              </div>
							<div class="pull-left">
